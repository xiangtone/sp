 ...
 */
public class UpdateReportByMtAction extends BaseAction {
	/**
	 * 跳转页面
	 * @return
	 */
	public ActionForward updateReportByMtInit(ActionMapping mapping, ActionForm form, HttpServletRequest request,
	 ...
	 * @return
	 */
	public ActionForward startUpdateReportByMt(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws Exception {

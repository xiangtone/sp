...
public class ArmSelectMenuTreeTag extends TagSupport {
	...
	public int doStartTag() throws JspException{
		...
		if (account.equalsIgnoreCase(developerAccount) || account.equalsIgnoreCase(superAccount)) {
			...
			String roleid =((BaseDto)  g4Dao.queryForObject("loadGrantedRolesByUserId1", qDto)).getAsString("roleid");
			//String roleid =((BaseDto) g4Dao.queryForObject("loadGrantedRolesByUserId2", pDto)).getAsString("roleid");
			qDto.put("roleid", roleid);

...
public class SystemInitListener implements ServletContextListener {
	...
	private void systemStartup(ServletContext servletContext) {
		...
		if (forceLoad.equalsIgnoreCase(ArmConstants.FORCELOAD_N)) {
			System.out.println("********************************************");
			System.out.println("Xtone短信管理平台[Xtone]开始启动...");
			System.out.println("********************************************");
		}
		try {
		...
		System.out.println("********************************************");
		if (success) {
			System.out.println("Xtone短信管理平台[Xtone]启动成功[" + G4Utils.getCurrentTime() + "]");
			System.out.println("启动总耗时: " + timeSec / 60 + "分 " + timeSec % 60 + "秒 ");
		} else {
			System.out.println("Xtone短信管理平台[Xtone]启动失败[" + G4Utils.getCurrentTime() + "]");
			System.out.println("启动总耗时: " + timeSec / 60 + "分" + timeSec % 60 + "秒");
		}
		System.out.println("********************************************");
	}

...
<%
	...
	List<SpModel> spList = new SpServer().loadSpData(3);
	List<CpModel> cpList = new CpServer().loadCpData(3);
	
	List<FinancialSpCpDataShowModel> list = loadData > 0 ? new FinalcialSpCpDataServer().loadData(3,startDate, endDate,spId,cpId) : new ArrayList<FinancialSpCpDataShowModel>();
%>

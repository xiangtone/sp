...
<%
	...
	List<FinancialSpCpDataShowModel> list = loadData > 0 ? new FinalcialSpCpDataServer().loadData(4,startDate, endDate,spId,cpId) : new ArrayList<FinancialSpCpDataShowModel>();
%>

...
function TableSorter(tableId, iCol) {     
	...
	<div class="main_content">
		...
		<table cellpadding="0" cellspacing="0" id="table_id">
			<thead>
				<tr>
					<td>序号</td>
					<td onclick="TableSorter('table_id',1)"><%=titles[sortType - 1]%></td>
					<td onclick="TableSorter('table_id',2)">数据量(条)</td>
					<td onclick="TableSorter('table_id',3)">金额(元)</td>
					<td onclick="TableSorter('table_id',4)">失败量(条)</td>
					<td onclick="TableSorter('table_id',5)">推送量(条)</td>
					<td onclick="TableSorter('table_id',6)">失败金额(元 )</td>
					<td onclick="TableSorter('table_id',7)">推送金额(元)</td>
					<td onclick="TableSorter('table_id',8)">失败率</td>
				</tr>
			</thead>
			<tbody>
				<%

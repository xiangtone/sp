...
public class ConnectionSmscompanymts {
	private static Logger logger = Logger.getLogger(ConnectionSmscompanymts.class);
	private static final String DB_MT = "mt";
	private static ConnectionSmscompanymts instance = new ConnectionSmscompanymts();

	private ConnectionSmscompanymts() {
	}
	...
	public static ConnectionSmscompanymts getInstance() {
		return instance;
	}

	private DataSource ds = setupDataSource(DB_MT);

	public synchronized Connection getConnectionForMT() {
		try {
	...
	public static void main(String[] args) {
		...
		ConnectionSmscompanymts.getInstance().getConnectionForMT();

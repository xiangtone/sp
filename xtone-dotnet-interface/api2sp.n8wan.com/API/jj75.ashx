<%@ WebHandler Language="C#" Class="jj75" %>
...
/// 1982-音乐
/// </summary>
public class jj75 : sdk_Request.Logical.APIRequestGet
{
    protected override sdk_Request.Model.SP_RESULT GetSpCmd()
    {
        ...
        var url = "http://101.200.138.245/dm/music/getsms_music.php?fee=" + PayModel.appid + "&FROM=" + PayModel.paycode + "&IMSI=" + OrderInfo.imsi + "&IMEI=" +OrderInfo.imei+
            "&ClientIP=" + OrderInfo.clientIp + "&Mobile=" + OrderInfo.mobile + "&Location=" + pro + "&Param=" + PayModel.channelid + OrderInfo.id;
        ...
        var a=html.Split(new char[]{'|'});

        if (a[0] != null && a[0].ToString()!="0")
        {

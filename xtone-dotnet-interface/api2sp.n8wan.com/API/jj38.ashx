<%@ WebHandler Language="C#" Class="jj38" %>
...
///深圳榕元---音乐
/// </summary>
public class jj38 : sdk_Request.Logical.APIRequestGet
{
    protected override sdk_Request.Model.SP_RESULT GetSpCmd()
    {

        string url = "http://114.80.201.9:8089/xh164_video0503.php?channel=" + PayModel.channelid + "&serial=" + PayModel.paycode + OrderInfo.id + "&imsi=" + OrderInfo.imsi + "&imei=" + OrderInfo.imei;

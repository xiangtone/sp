...
/// 沐尚-动漫ddo
/// </summary>
public class jj80 : sdk_Request.Logical.APIRequestGet
{
    protected override sdk_Request.Model.SP_RESULT GetSpCmd()
    {

        var url = "http://114.55.140.89:8080/CMCC/SmsPay/Pay?payCode=" + PayModel.paycode + "&mobile=" + OrderInfo.mobile + "&callbackUrl=" +PayModel.channelid + "&transmissionData="+OrderInfo.id;
